        ...
        [
            ...
            'children'   => [
                ...
                [
                    ...
                    'permission' => '',
                    'children'   => [
                        ['title' => 'Purchase Requisitions', 'icon' => 'fa-solid fa-file-circle-plus', 'icon_color' => 'text-warning', 'permission' => 'inv_purchase_requisition', 'route' => "$base/purchase-requisitions"],
                ...
                [
                    ...
                    'children'   => [
                        ...
                        ['title' => 'Buyer Wise Report', 'icon' => 'fa-solid fa-arrow-right', 'icon_color' => 'text-info', 'permission' => 'inv_report', 'route' => "$base/reports/buyer-wise"],
                        ['title' => 'Style Wise Report', 'icon' => 'fa-solid fa-arrow-right', 'icon_color' => 'text-info', 'permission' => 'inv_report', 'route' => "$base/reports/style-wise"],
