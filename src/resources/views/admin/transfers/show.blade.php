...
<div class="flex-grow-1 inv-module">
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h4 class="mb-0">Transfer {{ $transfer->transfer_no }}</h4>
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-sm align-middle">
                    <thead>
                        <tr><th>Item</th><th>Unit</th><th>Color</th><th>Size</th><th class="text-right">Quantity</th><th class="text-right">Received Qty</th></tr>
                    </thead>
                    <tbody>
                        @foreach($transfer->items as $item)
                            <tr>
                                ...
                                <td class="text-right">{{ inv_qty($item->quantity) }}</td>
