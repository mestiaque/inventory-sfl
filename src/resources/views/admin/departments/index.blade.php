        ...
        <div class="card-body">
            <form method="GET" class="row mb-3 align-items-end">
                ...
                <div class="col-md-3 mb-2 d-flex align-items-end flex-wrap gap-1">
                    ...
                    <a href="{{ route('inventory.departments.index') }}" class="btn btn-light btn-sm">Reset</a>
                </div>
            </form>
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-sm align-middle">
                    <thead>
                        <tr><th>#</th><th>Name</th><th>Code</th><th>Default Floor Store</th><th>Status</th><th class="text-right">Actions</th></tr>
                    </thead>
                    <tbody>
                        @forelse($departments as $department)
                            <tr>
                                ...
                                <td class="text-right">
                                    <button type="button" class="btn-custom success" data-toggle="modal" data-target="#viewDepartmentModal{{ $department->id }}"><i class="fa-solid fa-eye"></i></button>
                                    @can('inv_department.edit')
                                        <button type="button" class="btn-custom yellow" data-toggle="modal" data-target="#editDepartmentModal{{ $department->id }}"><i class="fa-solid fa-pen"></i></button>
                                    @endcan
                                    @can('inv_department.delete')
                                        <button type="button" class="btn-custom danger" data-toggle="modal" data-target="#deleteDepartmentModal" data-action="{{ route('inventory.departments.destroy', $department) }}"><i class="fa-solid fa-trash"></i></button>
                                    @endcan
                                </td>
                            </tr>
