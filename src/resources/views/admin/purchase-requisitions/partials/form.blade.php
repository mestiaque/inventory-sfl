...
<div class="row">
    ...
    <div class="col-md-4 mb-3">
        ...
        <input type="date" name="requisition_date" class="form-control" value="{{ old('requisition_date', optional($purchaseRequisition->requisition_date ?? null)->format('Y-m-d') ?? now()->toDateString()) }}" required>
    </div>
    <div class="col-12 mb-3">
        <label class="form-label">Remarks</label>
        <textarea name="remarks" class="form-control" rows="2">{{ old('remarks', $purchaseRequisition->remarks ?? '') }}</textarea>
    </div>
</div>
