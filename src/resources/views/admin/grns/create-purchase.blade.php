...
<div class="flex-grow-1 inv-module">
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="mb-0">Purchase Challan — against {{ $purchaseOrder->po_number }}</h5>
            <a href="{{ route('inventory.purchase-orders.show', $purchaseOrder) }}" class="btn btn-light btn-sm"><i class="fa-solid fa-arrow-left"></i> Back</a>
        </div>
        <div class="card-body">
            <form method="POST" action="{{ route('inventory.grns.store') }}">
                ...
                <a href="{{ route('inventory.purchase-orders.show', $purchaseOrder) }}" class="btn btn-light mt-3">Cancel</a>
            </form>
        </div>
    </div>
</div>
