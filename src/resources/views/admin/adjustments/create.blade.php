            ...
            <form method="POST" action="{{ route('inventory.adjustments.store') }}">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-sm align-middle">
                        <thead><tr><th style="min-width:220px">Item</th><th style="width:130px">Color</th><th style="width:130px">Size</th><th style="width:160px">Physical Qty</th><th style="width:40px"></th></tr></thead>
