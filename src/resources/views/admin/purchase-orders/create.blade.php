...
<div class="flex-grow-1 inv-module">
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="mb-0">Add Store Order{{ $purchaseRequisition ? ' — against ' . $purchaseRequisition->requisition_no : '' }}</h5>
        ...
        <div class="card-body">
            @unless($purchaseRequisition)
                ...
                <select id="prPicker" class="form-control inv-select2" style="max-width:480px;">
            ...
            @else
                <form method="POST" action="{{ route('inventory.purchase-orders.store') }}">
                    ...
                    <a href="{{ route('inventory.purchase-orders.create') }}" class="btn btn-light mt-3">Change Requisition</a>
                </form>
            @endunless
        </div>
    </div>
