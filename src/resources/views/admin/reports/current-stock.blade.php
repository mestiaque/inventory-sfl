        ...
        <div class="card-body">
            @unless($printMode)
                <form method="GET" class="row mb-3 align-items-end">
                    ...
                    <div class="col-md-3 mb-2 d-flex align-items-end flex-wrap gap-1">
                        ...
                        <a href="{{ route('inventory.reports.current-stock') }}" class="btn btn-light btn-sm">Reset</a>
                    </div>
                </form>
            @endunless
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-sm align-middle">
                    <thead><tr><th>Item Code</th><th>Item Name</th><th>Category</th><th>Unit</th><th class="text-right">Current Stock (All Stores)</th><th class="text-right">Rate</th><th class="text-right">Stock Value</th></tr></thead>
                    <tbody>
                        @forelse($items as $item)
                            <tr>
                                ...
                                <td class="text-right">{{ inv_qty($item->current_stock) }}</td>
