        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-sm align-middle">
                    <thead><tr><th>GRN No</th><th>PO No</th><th>Store</th><th>Supplier</th><th>Date</th><th class="text-right">Total</th></tr></thead>
                    <tbody>
                        @forelse($grns as $grn)
                            <tr>
                                ...
                                <td class="text-right">{{ inv_qty($grn->total_amount) }}</td>
                            </tr>
                        @empty
