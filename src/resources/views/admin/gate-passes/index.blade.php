        ...
        <div class="card-body">
            <form method="GET" class="row mb-3 align-items-end">
                ...
                <div class="col-md-3 mb-2 d-flex align-items-end flex-wrap gap-1">
                    ...
                    <a href="{{ route('inventory.gate-passes.index') }}" class="btn btn-light btn-sm">Reset</a>
                </div>
            </form>
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-sm align-middle">
                    <thead>
                        <tr><th>#</th><th>Gate Pass No</th><th>Shipment</th><th>Buyer</th><th>Vehicle</th><th>Store</th><th>Date</th><th>Status</th><th class="text-right">Actions</th></tr>
                    </thead>
                    <tbody>
                        @forelse($gatePasses as $gatePass)
                            <tr>
                                ...
                                <td>
                                    <span class="badge badge-{{ ['pending' => 'secondary', 'issued' => 'success', 'cancelled' => 'danger'][$gatePass->status] ?? 'secondary' }}">
                                        {{ ucfirst($gatePass->status) }}
                                    </span>
                                </td>
                                <td class="text-right">
                                    <button type="button" class="btn-custom success" data-toggle="modal" data-target="#viewGpModal{{ $gatePass->id }}"><i class="fa-solid fa-eye"></i></button>
