...
<div class="col-md-3 mb-3">
    ...
    <input type="text" name="name" class="form-control form-control-sm" value="{{ old('name', $operator?->name ?? '') }}" required>
</div>
<div class="col-md-3 mb-3">
    <label class="form-label">Code <span class="text-danger">*</span></label>
    <input type="text" name="code" class="form-control form-control-sm" value="{{ old('code', $operator?->code ?? '') }}" required>
</div>
<div class="col-md-3 mb-3">
    <label class="form-label">System Login <span class="text-danger">*</span></label>
    <select name="user_id" class="form-control form-control-sm inv-select2" required>
...
<div class="col-md-3 mb-3">
    ...
    <select name="designation" class="form-control form-control-sm operator-designation" required>
...
<div class="col-md-3 mb-3 operator-store-field">
...
<div class="col-md-3 mb-3 d-flex align-items-center"><div class="custom-control custom-switch mb-4">
    ...
    <input type="checkbox" name="is_active" value="1" class="custom-control-input" id="operatorActive{{ $operator?->id ?? 'new' }}"
        @checked(old('is_active', $operator?->is_active ?? true))>
    <label class="custom-control-label" for="operatorActive{{ $operator?->id ?? 'new' }}">Active</label>
</div>
</div></div>
