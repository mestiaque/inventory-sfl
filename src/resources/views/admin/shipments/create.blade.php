            ...
            <form method="POST" action="{{ route('inventory.shipments.store') }}">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="date" name="shipment_date" class="form-control form-control-sm" value="{{ old('shipment_date', now()->toDateString()) }}" required>
                    </div>
                    <div class="col-md-3 mb-3">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="text" name="packing_list_no" class="form-control form-control-sm" value="{{ old('packing_list_no') }}">
                    </div>
                ...
                <button type="submit" class="btn btn-primary mt-3 btn-sm">Save Shipment</button>
                <a href="{{ route('inventory.shipments.index') }}" class="btn btn-light mt-3 btn-sm">Cancel</a>
            </form>
        </div>
    </div>
</div>
